 ...
 * 연속 학습 모드 통합 컨트롤러.
 *
 * <p>코스 조회 + 연속 학습 문제 풀이를 하나의 컨트롤러에서 제공한다.</p>
 *
 * <h3>엔드포인트</h3>
 * <ul>
...
public class ContinuousQuizController {
     ...
     */
    @Operation(summary = "섹션 목록 조회 (진행 상황 포함)",
            description = "인증된 사용자의 진행 상황이 포함된 섹션 목록을 조회합니다.")
     ...
     */
    @Operation(summary = "정답 제출 및 다음 문제 조회",
            description = "현재 문제의 정답을 제출하고 FSRS 상태를 업데이트한 뒤, 다음 문제를 즉시 반환합니다.")
