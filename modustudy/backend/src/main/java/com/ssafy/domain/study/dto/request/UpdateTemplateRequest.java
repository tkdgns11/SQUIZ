...
public class UpdateTemplateRequest {
    ...
    @Schema(description = "템플릿 이름", example = "알고리즘 스터디 템플릿 v2")
    ...
    @Schema(description = "주제", example = "백준 플래티넘 달성")
    @Size(max = 50, message = "주제는 50자 이내여야 합니다")
    private String topic;

    @Schema(description = "형식", example = "문제 풀이 + 코드 리뷰 + 회고")
    ...
    @Schema(description = "스터디 설명", example = "백준 플래티넘 티어를 목표로 하는 심화 알고리즘 스터디")
    ...
    @Schema(description = "스터디 목표", example = "6개월 내 플래티넘 티어 달성")
    @Size(max = 500, message = "목표는 500자 이내여야 합니다")
    private String goal;

    @Schema(description = "난이도", example = "ADVANCED")
    private Difficulty difficulty;

    @Schema(description = "참가 조건", example = "골드 티어 이상")
    private String prerequisites;

    @Schema(description = "진행 방식 상세", example = "매주 5문제 풀이 후 코드 리뷰 및 회고")
    private String processDetail;

    @Schema(description = "패널티 정책", example = "STRICT")
