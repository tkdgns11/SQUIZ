...
목표: 초기 탐색 토큰을 줄이기 위해 핵심 위치/파일을 빠르게 안내한다.

## 공통 위치
- 프론트엔드: `frontend/`
- 백엔드: `backend/`
- 문서: `docs/`
- 인프라: `docker-compose.yml`, `nginx/`
...
## 백엔드 핵심
- 도메인 루트: `backend/src/main/java/com/ssafy/domain/`
- 회의: `backend/src/main/java/com/ssafy/domain/meeting/`
  ...
  - 엔티티/리포: `backend/src/main/java/com/ssafy/domain/meeting/entity/`, `backend/src/main/java/com/ssafy/domain/meeting/repository/`
...
- 채팅/보드/알림: `backend/src/main/java/com/ssafy/domain/chat/`, `backend/src/main/java/com/ssafy/domain/board/`, `backend/src/main/java/com/ssafy/domain/notification/`
- 업로드 저장소: `backend/src/main/java/com/ssafy/common/storage/LocalFileStorageService.java`
...
## 빠른 검색 예시
- 회의 관련: `rg -n "MeetingRoom|MeetingDetail|meetingApi" frontend/src/features/meeting -S`
